...
const QualityPolicy = () => {
  ...
  <div class="hero-content flex-col lg:flex-row-reverse">
    <img src={qualityPic} style={{backgroundColor: 'orange'}} class="max-w-sm rounded-lg shadow-2xl lg:w-64" alt='qualityPic' />
    <div>
      <h1 class="text-5xl font-bold lg:px-6">Quality Policy</h1>
